  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          // Base styles
          "group/drawer-content fixed z-50 flex h-screen flex-col bg-popover text-sm text-popover-foreground",
          
          // Right drawer - big screens (50% width)
          "data-[vaul-drawer-direction=right]:inset-y-0 data-[vaul-drawer-direction=right]:right-0 data-[vaul-drawer-direction=right]:w-1/2 data-[vaul-drawer-direction=right]:rounded-l-xl data-[vaul-drawer-direction=right]:border-l data-[vaul-drawer-direction=right]:bg-white",
          
          // Right drawer - medium screens (75% width)
          "md:data-[vaul-drawer-direction=right]:w-3/4",
          
          // Right drawer - small screens (full width)
          "sm:data-[vaul-drawer-direction=right]:w-full sm:data-[vaul-drawer-direction=right]:rounded-none",
          
          // Bottom drawer (default behavior)
        ...
        {...props}
      >
        {/* Hide the bottom drawer handle for right-side drawers */}
