// app/(dashboard)/admission/icu/all-patients/_components/icu-stats.tsx
"use client";
...
export function IcuStat({ label, value, subtitle, icon, tone }: { label: string; value: string; subtitle: string; icon: ReactNode; tone: Tone }) {
