// app/(dashboard)/rmo/icu/patients/[uhid]/page.tsx
"use client";
...
import { LabForm } from "@/app/(dashboard)/doctor/icu/all-patients/[uhid]/_components/lab-form";
import { DiagnosisForm } from "@/app/(dashboard)/doctor/icu/all-patients/[uhid]/_components/diagnosis-form";
import { VentilatorOrderForm } from "@/app/(dashboard)/doctor/icu/all-patients/[uhid]/_components/ventilator-order-form";
import { OxygenOrderForm } from "@/app/(dashboard)/doctor/icu/all-patients/[uhid]/_components/oxygen-order-form";
import { TabDischarge } from "@/app/(dashboard)/doctor/icu/all-patients/[uhid]/_components/tab-discharge";
import { PatientHeader } from "@/app/(dashboard)/doctor/icu/all-patients/[uhid]/_components/patientHeader";
import { Badge, CheckCircle2 } from "lucide-react";
import { MedicineForm } from "@/app/(dashboard)/doctor/icu/all-patients/[uhid]/_components/medicine-form";
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-[1600px] space-y-5">
        <PatientHeader
          ...
          handleClick={() => router.push("/rmo/icu/all-patients")}
        />
