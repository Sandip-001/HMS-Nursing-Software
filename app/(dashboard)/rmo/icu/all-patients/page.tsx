...
import { NurseIpdPatientsGrid } from "../../../nurse/ipd/patients/_components/nurse-ipd-patients-grid";
import { getNurseIpdColumns, defaultNurseColumnVisibility } from "../../../nurse/ipd/patients/_components/nurse-ipd-columns";
...
import { NurseIpdStat } from "../../../nurse/ipd/patients/_components/nurse-ipd-stats";
import { NurseIpdFilters } from "../../../nurse/ipd/patients/_components/nurse-ipd-filters";
        ...
        <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full border border-blue-200 bg-blue-50 px-2.5 py-1 text-xs font-semibold text-blue-700">RMO</span>
            </div>
