// app/(dashboard)/rmo/ipd/all-patients/_components/drawer/section-treatment-plan.tsx
import { CheckCircle2, ClipboardCheck, XCircle } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import type { TreatmentPlanItem } from "@/types/rmo/ipd/rmo-types";
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-1 text-xs text-slate-500">Whether the assigned nurse is currently following each plan item.</p>
      </div>
