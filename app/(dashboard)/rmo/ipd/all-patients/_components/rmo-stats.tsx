// app/(dashboard)/rmo/ipd/all-patients/_components/rmo-stats.tsx
...
export function RmoStat({ label, value, subtitle, icon, tone }: { label: string; value: string; subtitle: string; icon: ReactNode; tone: Tone }) {
