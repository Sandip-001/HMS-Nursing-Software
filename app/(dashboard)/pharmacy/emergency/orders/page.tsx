...
export default function PharmacyIpdOrdersPage() {
    ...
    <div className="min-h-screen ">
      <div className="mx-auto max-w-[1700px] space-y-6">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-bold text-slate-800 sm:text-3xl">Pharmacy Emergency Orders</h1>
            </div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <PharmacyIpdStat icon={<ReceiptText className="h-5 w-5" />} label="Total Emergency Orders" value={String(stats.totalOrders)} subtitle={`${stats.totalMedicines} medicines ordered`} tone="blue" />
  ...
  <p className="min-w-0 shrink text-sm text-slate-500">
    Showing <span className="font-bold text-slate-800">{filteredOrders.length}</span> pharmacy Emergency order{filteredOrders.length !== 1 ? "s" : ""}
  </p>
