// app/(dashboard)/nurse-admin/ipd/beds/_components/beds-stats.tsx
...
export function BedStat({ label, value, subtitle, icon, tone }: { label: string; value: string; subtitle: string; icon: ReactNode; tone: Tone }) {
