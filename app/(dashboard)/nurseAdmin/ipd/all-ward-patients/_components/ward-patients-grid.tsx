// app/(dashboard)/nurse-admin/ipd/all-ward-patients/_components/ward-patients-grid.tsx
"use client";
...
export function WardPatientsGrid({ patients, onView }: { patients: WardPatientFull[]; onView: (patient: WardPatientFull) => void }) {
  return (
