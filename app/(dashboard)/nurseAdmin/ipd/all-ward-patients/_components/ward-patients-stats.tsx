// app/(dashboard)/nurse-admin/ipd/all-ward-patients/_components/ward-patients-stats.tsx
...
export function WardStat({ label, value, subtitle, icon, tone }: { label: string; value: string; subtitle: string; icon: ReactNode; tone: Tone }) {
