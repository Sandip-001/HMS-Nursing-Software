// app/(dashboard)/nurse-admin/ipd/new-admissions/_components/nurse-admin-stats.tsx
...
export function NurseAdminStat({ label, value, subtitle, icon, tone }: { label: string; value: string; subtitle: string; icon: ReactNode; tone: Tone }) {
