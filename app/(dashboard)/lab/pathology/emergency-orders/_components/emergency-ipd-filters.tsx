// app/(dashboard)/lab/pathology/emergency-orders/_components/pathology-ipd-filters.tsx
"use client";
...
export function PathologyEmergencyFilters({
  filters,
  results,
  doctors,
  categories,
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-bold text-slate-800">
              Search & Filter Emergency Pathology Orders
            </p>
