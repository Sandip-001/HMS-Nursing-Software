...
import { RadiologyICUFilters } from "./_components/icu-filters";
...
export default function RadiologyICUOrdersPage() {
  const [orders, setOrders] =
    useState<RadiologyIpdOrder[]>(RADIOLOGY_ICU_ORDERS);
    ...
    <div className="min-h-screen">
      <div className="mx-auto max-w-[1600px] space-y-6">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Process ICU imaging orders, upload reports, and manage direct or
        ...
        <RadiologyICUFilters
          ...
          doctors={RADIOLOGY_ICU_DOCTORS}
          categories={RADIOLOGY_ICU_CATEGORIES}
        ...
        <div className="flex items-center justify-between">
          <p className="text-sm text-slate-500">
            ...
            radiology ICU order{filteredOrders.length !== 1 ? "s" : ""}
          </p>
