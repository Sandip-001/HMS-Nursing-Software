// app/(dashboard)/lab/radiology/ipd-orders/_components/radiology-ipd-stats.tsx
import type { ReactNode } from "react";
import { Card, CardContent } from "@/components/ui/card";
import { cn } from "@/lib/utils";
type Tone = "blue" | "sky" | "emerald" | "amber" | "rose";
...
export function RadiologyIpdStat({
  label,
  value,
  subtitle,
  icon,
