// app/(dashboard)/nurse/ipd/patients/_components/nurse-ipd-stats.tsx
...
export function NurseIpdStat({ label, value, subtitle, icon, tone }: { label: string; value: string; subtitle: string; icon: ReactNode; tone: Tone }) {
