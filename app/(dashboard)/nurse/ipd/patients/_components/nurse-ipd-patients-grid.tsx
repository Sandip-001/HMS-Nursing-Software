// app/(dashboard)/nurse/ipd/patients/_components/nurse-ipd-patients-grid.tsx
"use client";
...
export function NurseIpdPatientsGrid({ patients, onView }: { patients: NurseIpdPatient[]; onView: (patient: NurseIpdPatient) => void }) {
  return (
        ...
        return (
          <Card key={patient.uhid} className="overflow-hidden border-slate-200 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg">
            ...
            <CardContent className="p-5">
              ...
              <Button className="mt-4 w-full border-blue-200 text-blue-700" variant="outline" onClick={() => onView(patient)}>
