...
export function NurseIpdFilters({ filters, results, wards, shifts, onChange, onReset }: Props) {
      ...
      <div className="flex flex-col gap-3 border-b border-slate-100 bg-gradient-to-r from-slate-50 to-blue-50/60 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Filter by patient, ward, acuity, or shift.</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
