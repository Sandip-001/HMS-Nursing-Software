...
import { NurseIpdStat } from "./_components/nurse-ipd-stats";
import { NurseIpdFilters } from "./_components/nurse-ipd-filters";
import { NurseIpdPatientsGrid } from "./_components/nurse-ipd-patients-grid";
import { getNurseIpdColumns, defaultNurseColumnVisibility } from "./_components/nurse-ipd-columns";
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto max-w-[1700px] space-y-6">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-bold text-slate-800 sm:text-3xl">My IPD Patients</h1>
            ...
            <p className="mt-1 text-sm text-slate-500">Manage vitals, medication administration, and care plans for your assigned patients.</p>
          </div>
        </header>
        ...
        <NurseIpdFilters filters={filters} results={filteredPatients.length} wards={NURSE_IPD_WARDS} shifts={NURSE_IPD_SHIFTS} onChange={updateFilter} onReset={() => setFilters(initialFilters)} />
