// app/(dashboard)/doctor/icu/patients/[uhid]/_components/tab-discharge.tsx
"use client";
    ...
    <div className="space-y-4">
      <Card className="border-slate-200">
        <CardContent className="p-5">
          <p className="flex items-center gap-2 text-sm font-bold text-slate-800"><LogOut className="h-4 w-4 text-red-600" />Doctor Discharge Summary</p>
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-3 text-xs text-slate-500">Discharged by: <span className="font-semibold text-slate-700">{"Dr. Rajesh Sharma"}</span></div> 
