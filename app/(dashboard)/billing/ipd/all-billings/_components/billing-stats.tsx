// app/(dashboard)/billing/ipd/_components/billing-stats.tsx
...
export function BillingStat({ label, value, subtitle, icon, tone }: { label: string; value: string; subtitle: string; icon: ReactNode; tone: Tone }) {
